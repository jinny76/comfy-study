...
**便携版:**
- 下载新版本覆盖安装
- 保留 `models/`、`custom_nodes/`、`input/`、`output/` 目录
...
更新前建议备份：
- `custom_nodes/` - 自定义节点配置
- `user/` - 用户设置和工作流
- `models/` - 模型文件（通常不需要，占空间大）
...
- [ComfyUI Commits](https://github.com/comfyanonymous/ComfyUI/commits/master)
